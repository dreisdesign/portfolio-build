...
const FOOTER_HTML = `\n    <!-- FOOTER -->\n    <div class="wrapper">\n        <footer class="footer" role="contentinfo">\n            <p>\n                <b><a href="https://github.com/dreisdesign/portfolio-build?tab=readme-ov-file#portfolio-build-system" target="_blank" rel="noopener noreferrer">Designed and Developed</a></b> by {{AUTHOR_NAME}}\n            </p>\n        </footer>\n    </div>\n`;
